// the function SimpleSymbols(str) take the str parameter being
...
// would be false. The string will not be empty and will have at
// least one letter.
...
function SimpleSymbols(str){
  for(var i=0; i<str.length; i++){
    if(str[i].match(/^[A-z]+$/)){
      var back = i-1;
      var front = i+1;
      var condition = (str[back]=='+' && str[front]=='+');
